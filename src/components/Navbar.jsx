        ...
        <div className={`fixed top-0 left-0 w-full transition-all duration-300 z-50 ${isScrolled ? 'bg-[#0a0a0a] shadow-lg' : 'bg-transparent'}`}>
            <div className='flex w-full justify-evenly items-center py-5'>
                ...
                <div className='flex text-[#d1d1d1] ml-12 gap-8 text-lg'>
                    <Link href='/events' className='relative hover:text-white/50 mt-3 duration-200  pb-2 after:content-[""] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-0.5 after:bg-[#c1ed14] after:transition-all after:duration-300 hover:after:w-full'>
                        <h2>Events</h2>
                    </Link>
                    <Link href='/about' className='relative hover:text-white/50  mt-3 duration-200  pb-2 after:content-[""] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-0.5 after:bg-[#c1ed14] after:transition-all after:duration-300 hover:after:w-full'>
                        <h2>About</h2>
                    </Link>
                    <Link href='/community' className='relative hover:text-white/50  mt-3 duration-200  pb-2 after:content-[""] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-0.5 after:bg-[#c1ed14] after:transition-all after:duration-300 hover:after:w-full'>
                        <h2>Community</h2>
                    </Link>
                </div>
