...
export async function GET() {
    try {
        ...
        const database = client.db("eventara");  // Make sure this matches your DB
        const collection = database.collection("events");  // Ensure this is the correct collection name
